...
export function RelationBindCardControl({ relationId, available, onBind, onUnbind, boundIds }: Props) {
  ...
  return (
    <div className="flex flex-col gap-2" data-relation-id={relationId}>
